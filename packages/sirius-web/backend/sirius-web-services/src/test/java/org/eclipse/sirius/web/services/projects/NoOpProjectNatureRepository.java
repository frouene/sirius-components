...
public class NoOpProjectNatureRepository implements IProjectNatureRepository {
    ...
    @Override
    public <S extends ProjectNatureEntity> Iterable<S> saveAll(Iterable<S> entities) {
        return null;
    }
    ...
    @Override
    public Iterable<ProjectNatureEntity> findAll() {
        return null;
    }

    @Override
    public Iterable<ProjectNatureEntity> findAllById(Iterable<UUID> ids) {
        return null;
    }

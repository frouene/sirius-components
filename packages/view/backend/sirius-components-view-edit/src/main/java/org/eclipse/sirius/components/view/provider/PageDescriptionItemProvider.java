...
public class PageDescriptionItemProvider extends ItemProviderAdapter
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.PAGE_DESCRIPTION__TOOLBAR_ACTIONS, ViewFactory.eINSTANCE.createButtonDescription()));
